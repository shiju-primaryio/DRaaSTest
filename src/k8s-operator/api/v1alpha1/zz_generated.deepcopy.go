...
func (in *SiteSpec) DeepCopyInto(out *SiteSpec) {
	*out = *in
	...
	out.VMPowerSchema = in.VMPowerSchema
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMPowerRequst) DeepCopyInto(out *VMPowerRequst) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMPowerRequst.
func (in *VMPowerRequst) DeepCopy() *VMPowerRequst {
	if in == nil {
		return nil
	}
	out := new(VMPowerRequst)
	in.DeepCopyInto(out)
	return out
}
