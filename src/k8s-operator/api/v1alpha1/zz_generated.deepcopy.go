...
func (in *AppDRUnitStatus) DeepCopyInto(out *AppDRUnitStatus) {
	*out = *in
	...
	if in.FailoverVmListStatus != nil {
		in, out := &in.FailoverVmListStatus, &out.FailoverVmListStatus
		*out = make([]TriggerFailoverVmMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.FailbackVmListStatus != nil {
		in, out := &in.FailbackVmListStatus, &out.FailbackVmListStatus
		*out = make([]TriggerFailbackVmMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailbackStatus) DeepCopyInto(out *FailbackStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailbackStatus.
func (in *FailbackStatus) DeepCopy() *FailbackStatus {
	if in == nil {
		return nil
	}
	out := new(FailbackStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InitiateFailbackRequest) DeepCopyInto(out *InitiateFailbackRequest) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InitiateFailbackRequest.
func (in *InitiateFailbackRequest) DeepCopy() *InitiateFailbackRequest {
	if in == nil {
		return nil
	}
	out := new(InitiateFailbackRequest)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerFailbackVmMapping) DeepCopyInto(out *TriggerFailbackVmMapping) {
	*out = *in
	if in.VmdkStatusList != nil {
		in, out := &in.VmdkStatusList, &out.VmdkStatusList
		*out = make([]TriggerFailbackVmdkMapping, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerFailbackVmMapping.
func (in *TriggerFailbackVmMapping) DeepCopy() *TriggerFailbackVmMapping {
	if in == nil {
		return nil
	}
	out := new(TriggerFailbackVmMapping)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerFailbackVmdkMapping) DeepCopyInto(out *TriggerFailbackVmdkMapping) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerFailbackVmdkMapping.
func (in *TriggerFailbackVmdkMapping) DeepCopy() *TriggerFailbackVmdkMapping {
	if in == nil {
		return nil
	}
	out := new(TriggerFailbackVmdkMapping)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerFailoverVmMapping) DeepCopyInto(out *TriggerFailoverVmMapping) {
	*out = *in
	if in.VmdkStatusList != nil {
		in, out := &in.VmdkStatusList, &out.VmdkStatusList
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerFailoverVmMapping.
func (in *TriggerFailoverVmMapping) DeepCopy() *TriggerFailoverVmMapping {
	if in == nil {
		return nil
	}
	out := new(TriggerFailoverVmMapping)
	in.DeepCopyInto(out)
	return out
}
